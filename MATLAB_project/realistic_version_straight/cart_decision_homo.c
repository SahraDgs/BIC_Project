 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Sat May 30 16:12:29 2026
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                cart_decision_homo
...
extern void cart_decision_homo_Outputs_wrapper(const real_T *final_pos,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  cart_decision_homo_Outputs_wrapper(final_pos, current_theta_1, current_theta_2,
