 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Wed Jun 24 21:17:34 2026
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                combined_decision_homo
...
/* Input Port  0 */
#define IN_PORT_0_NAME                 final_pos
...
/* Input Port  1 */
#define IN_PORT_1_NAME                 current_theta_1
...
/* Input Port  2 */
#define IN_PORT_2_NAME                 current_theta_2
...
/* Input Port  3 */
#define IN_PORT_3_NAME                 current_theta_3
...
/* Input Port  4 */
#define IN_PORT_4_NAME                 delta_theta_deg
...
/* Output Port  1 */
#define OUT_PORT_1_NAME                best_next_theta_2_pos
...
/* Output Port  2 */
#define OUT_PORT_2_NAME                best_next_theta_3_pos
...
/* Output Port  3 */
#define OUT_PORT_3_NAME                best_next_theta_1_neg
...
/* Output Port  4 */
#define OUT_PORT_4_NAME                best_next_theta_2_neg
...
/* Output Port  5 */
#define OUT_PORT_5_NAME                best_next_theta_3_neg
...
extern void combined_decision_homo_Outputs_wrapper(const real_T *final_pos,
...
{
  const real_T *final_pos = (real_T *) ssGetInputPortRealSignal(S, 0);
  const real_T *current_theta_1 = (real_T *) ssGetInputPortRealSignal(S, 1);
  const real_T *current_theta_2 = (real_T *) ssGetInputPortRealSignal(S, 2);
  const real_T *current_theta_3 = (real_T *) ssGetInputPortRealSignal(S, 3);
  const real_T *delta_theta_deg = (real_T *) ssGetInputPortRealSignal(S, 4);
  real_T *best_next_theta_1_pos = (real_T *) ssGetOutputPortRealSignal(S, 0);
  real_T *best_next_theta_2_pos = (real_T *) ssGetOutputPortRealSignal(S, 1);
  real_T *best_next_theta_3_pos = (real_T *) ssGetOutputPortRealSignal(S, 2);
  ...
  combined_decision_homo_Outputs_wrapper(final_pos, current_theta_1,
    current_theta_2, current_theta_3, delta_theta_deg, best_next_theta_1_pos,
    best_next_theta_2_pos, best_next_theta_3_pos, best_next_theta_1_neg,
    best_next_theta_2_neg, best_next_theta_3_neg, end_effector_calculated);
}
