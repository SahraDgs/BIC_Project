 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Wed Jun 24 16:57:24 2026
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                combined_decision
...
extern void combined_decision_Outputs_wrapper(const real_T *final_pos,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  combined_decision_Outputs_wrapper(final_pos, current_theta_1, current_theta_2,
